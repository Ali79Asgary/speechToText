...
public class SoundRecorder extends Task<Void> {
    ...
    int filesCount = Objects.requireNonNull(new File("./AudioFiles").listFiles()).length;

    File wavFile = new File("./AudioFiles/RecordFile"+filesCount+".wav");
    ...
    public SoundRecorder(AnchorPane anchorPaneShow) {
...
//        boolean bigEndian = true;
    ...
    void setMeterOnEDT(final float rms, final float peak) {
        anchorPaneShow.setPrefWidth(peak);
